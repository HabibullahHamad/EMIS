...
@section('page_title', __('emis.create') . ' ' . __('emis.roles'))
            ...
            <form action="{{ route('roles.store') }}" method="POST" id="roleForm">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                    ...
                    <div class="permission-toolbar">
                        <button type="button" class="btn btn-success btn-sm" id="checkAllPermissions">{{ __('emis.check_all') }}</button>
                        <button type="button" class="btn btn-outline-danger btn-sm" id="uncheckAllPermissions">{{ __('emis.uncheck_all') }}</button>
                    </div>
                </div>
